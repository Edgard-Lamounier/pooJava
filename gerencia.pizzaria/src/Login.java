...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String strUser = "gerencia";
        String strPassword = "123321";
            if((strUser.equals(user.getText())) && (strPassword.equals(password.getText())) ){
                jfPizzaria jfPizzaria = new jfPizzaria();
                jfPizzaria.show();
            }
            else {
                JOptionPane.showMessageDialog(null,"Usuário e senha errados!");
            }
