...
public class CreditInquiry {
   ...
   private void readRecords()
   {
      ...
      {     
         ...
         input = new Scanner( new File( "C:/Users/Edgard/Documents/NetBeansProjects/jaArquivos/clients.txt" ) );
   ...
   private MenuOption getRequest()
   {
      ...
      System.out.printf( "\n%s\n%s\n%s\n%s\n%s\n",
         "Escolha uma opção:", " 1 - Imprime contas com saldo zero",
         " 2 - Imprime contas com saldo negativo",
         " 3 - Imprime contas com saldo positivo", " 4 - SAIR" );
